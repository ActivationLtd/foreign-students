 ...
 * @property-read \Illuminate\Database\Eloquent\Collection|\App\Group[] $sGroups
 * @property-read int|null $s_groups_count
 ...
 * @mixin \Eloquent
 */
class User extends \App\Projects\DgmeStudents\Modules\Users\User
{
   /*--------------------------------------
   | Note : Empty class.
