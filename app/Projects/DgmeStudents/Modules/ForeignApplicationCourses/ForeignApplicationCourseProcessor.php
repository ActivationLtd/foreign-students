...
class ForeignApplicationCourseProcessor extends ModelProcessor
{
    // Note: Pull in necessary traits
    use ForeignApplicationCourseProcessorHelper;
    ...
    */
     ...
     *
     * @param  ForeignApplicationCourse  $element
     * @return $this
     */
    ...
    {
        $rules = [
            // 'name' => 'required|between:1,100|'.'unique:foreign_application_courses,name,'.($element->id ?? 'null').',id,deleted_at,NULL',
            'is_active' => 'in:1,0',
        ];
