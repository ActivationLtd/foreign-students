...
class ForeignApplicationCourseDatatable extends ModuleDatatable
{
    // Note: Pull in necessary traits

    public $moduleName = 'foreign-application-courses';
    ...
    public function source()
    {
       ...
       return ForeignApplicationCourse::with(['updater:id,name']); // Model based query.
    }
