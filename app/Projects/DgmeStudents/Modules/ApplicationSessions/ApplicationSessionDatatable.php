...
class ApplicationSessionDatatable extends ModuleDatatable
{
    // Note: Pull in necessary traits

    public $moduleName = 'application-sessions';
    ...
    public function source()
    {
       ...
       return ApplicationSession::with(['updater:id,name']); // Model based query.
    }
    ...
    public function columns()
    {
        return [
            ...
            [$this->table.'.starts_on', 'starts_on', 'Start'],
            [$this->table.'.ends_on', 'ends_on', 'End'],
