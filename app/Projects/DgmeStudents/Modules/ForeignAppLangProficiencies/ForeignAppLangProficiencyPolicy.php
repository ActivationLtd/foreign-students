...
class ForeignAppLangProficiencyPolicy extends BaseModulePolicy
{
     ...
     *
     * @param  \App\User  $user
     * @param  \App\ForeignAppLangProficiency  $element
     * @return mixed
     */
    ...
    public function update($user, $element)
    {
        ...
        if ($element->foreignApplication && $element->foreignApplication->status == 'Submitted' && Time::differenceInHours($element->foreignApplication->submitted_at, now()) >= 24) {
            return false;
        }
        return true;
    }
