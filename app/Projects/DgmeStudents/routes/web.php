...
Route::middleware($middlewares)->group(function () use ($modules, $moduleGroups) {
    ...
    Route::get('foreign-student-applications/{foreignStudentApplication}/print-view', [ForeignStudentApplicationController::class, 'printView'])->name('applications.print-view');
});
