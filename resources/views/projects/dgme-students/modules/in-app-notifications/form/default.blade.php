 ...
 * @var \App\Projects\DgmeStudents\Modules\InAppNotifications\InAppNotificationViewProcessor $view
 */
...
@section('js')
    @parent
    @include('projects.dgme-students.modules.in-app-notifications.form.js')
@endsection