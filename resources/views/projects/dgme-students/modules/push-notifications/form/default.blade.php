 ...
 * @var \App\Projects\DgmeStudents\Modules\PushNotifications\PushNotificationViewProcessor $view
 */
...
@section('js')
    @parent
    @include('projects.dgme-students.modules.push-notifications.form.js')
@endsection